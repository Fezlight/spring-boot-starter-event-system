...
The library is published on Maven Central. The current version is `1.2.3`
...
```groovy
    implementation 'fr.fezlight:spring-boot-starter-event-system:1.2.3'
```
...
```groovy
    implementation 'fr.fezlight:spring-boot-starter-event-system-jdbc:1.2.3'
```
...
```groovy
    implementation 'fr.fezlight:spring-boot-starter-event-system-mongodb:1.2.3'
```
