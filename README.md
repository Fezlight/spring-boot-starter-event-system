...
[![Maven Central](https://maven-badges.sml.io/sonatype-central/fr.fezlight/spring-boot-starter-event-system/badge.svg?version=2.0.5)](https://maven-badges.sml.io/sonatype-central/fr.fezlight/spring-boot-starter-event-system?version=2.0.5)
...
The library is published on Maven Central. The current version is `2.0.5`
...
```groovy
    implementation 'fr.fezlight:spring-boot-starter-event-system:2.0.5'
```
...
```groovy
    implementation 'fr.fezlight:spring-boot-starter-event-system-jdbc:2.0.5'
```
...
```groovy
    implementation 'fr.fezlight:spring-boot-starter-event-system-mongodb:2.0.5'
```
