...
[![Maven Central](https://maven-badges.sml.io/sonatype-central/fr.fezlight/spring-boot-starter-event-system/badge.svg?version=1.3.3)](https://maven-badges.sml.io/sonatype-central/fr.fezlight/spring-boot-starter-event-system?version=1.3.3)
...
The library is published on Maven Central. The current version is `1.3.3`
...
```groovy
    implementation 'fr.fezlight:spring-boot-starter-event-system:1.3.3'
```
...
```groovy
    implementation 'fr.fezlight:spring-boot-starter-event-system-jdbc:1.3.3'
```
...
```groovy
    implementation 'fr.fezlight:spring-boot-starter-event-system-mongodb:1.3.3'
```
