...
[![codecov](https://codecov.io/github/Fezlight/${project.artifactId}/graph/badge.svg?token=dF6tkf1ypO)](https://codecov.io/github/Fezlight/${project.artifactId})
[![Maven Central](https://maven-badges.sml.io/sonatype-central/${project.groupId}/${project.artifactId}/badge.svg?version=${project.version})](https://maven-badges.sml.io/sonatype-central/${project.groupId}/${project.artifactId}?version=${project.version})
...
The library is published on Maven Central. The current version is `${project.version}`
...
See [Sonatype Maven Central](https://central.sonatype.com/artifact/${project.groupId}/${project.artifactId}) for
versions.
...
```groovy
    implementation '${project.groupId}:spring-boot-starter-event-system-jdbc:${project.version}'
```
...
```groovy
    implementation '${project.groupId}:spring-boot-starter-event-system-mongodb:${project.version}'
```
...
[Workflow Diagram](http://www.plantuml.com/plantuml/proxy?src=https://raw.githubusercontent.com/Fezlight/${project.artifactId}/main/resources/workflow.puml)
